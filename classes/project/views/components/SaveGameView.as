/**
 * classes.project.views.components.SaveGameView
 * @version 1.0.0
 * @author andrew page
 */
 package classes.project.views.components  {
	...
	public class SaveGameView extends BaseView  {
		
		private var _assetId:String;
		/**
		 * Constructor
		 */
		public function SaveGameView(sName:String, sAsset:String)  {
			super(sName, MovieClip(Server.getAsset(sAsset)));
			trace("Creating new SaveGameView() -- " + sName);
		...
		override public function show():void  {
			...
			this._display.gotoAndPlay("saveMenu");
			this.addGameMenuBtn();
			super.show();
