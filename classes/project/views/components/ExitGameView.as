/**
 * classes.project.views.components.ExitGameView
 * @version 1.0.0
 * @author andrew page
 */
 package classes.project.views.components  {
	...
	public class ExitGameView extends BaseView  {
		
		private var _assetId:String;
		/**
		 * Constructor
		 */
		public function ExitGameView(sName:String, sAsset:String)  {
			super(sName, MovieClip(Server.getAsset(sAsset)));
			trace("Creating new ExitGameView() -- " + sName);
		...
		override public function show():void  {
			...
			this._display.gotoAndPlay("exitGame");
			this.addGameMenuBtn();
			super.show();
