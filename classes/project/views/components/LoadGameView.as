/**
 * classes.project.views.components.LoadGameView
 * @version 1.0.0
 * @author andrew page
 */
 package classes.project.views.components  {
	...
	public class LoadGameView extends BaseView  {
		 ...
		 * Constructor
		 */
		public function LoadGameView(sName:String, sAsset:String)  {
			super(sName, MovieClip(Server.getAsset(sAsset)));
			trace("Creating new LoadGameView() -- " + sName);
		...
		override public function show():void  {
			...
			this._display.gotoAndPlay("loadMenu");
			this.addGameMenuBtn();
			super.show();
