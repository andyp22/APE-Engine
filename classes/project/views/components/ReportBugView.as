/**
 * classes.project.views.components.ReportBugView
 * @version 1.0.0
 * @author andrew page
 */
 package classes.project.views.components  {
	...
	public class ReportBugView extends BaseView  {
		
		private var _assetId:String;
		/**
		 * Constructor
		 */
		public function ReportBugView(sName:String, sAsset:String)  {
			super(sName, MovieClip(Server.getAsset(sAsset)));
			trace("Creating new ReportBugView() -- " + sName);
		...
		override public function show():void  {
			...
			this._display.gotoAndPlay("reportABug");
			this.addGameMenuBtn();
			super.show();
